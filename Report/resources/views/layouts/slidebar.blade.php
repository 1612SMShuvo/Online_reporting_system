...
<head>
	...
	<title>Neon | Purple Skin</title>
	

	<link rel="stylesheet" href="{{  asset('public/assets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css')}}">
	<link rel="stylesheet" href="{{  asset('public/assets/css/font-icons/entypo/css/entypo.css')}}">
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Noto+Sans:400,700,400italic">
	<link rel="stylesheet" href="{{  asset('public/assets/css/bootstrap.css')}}">
	<link rel="stylesheet" href="{{  asset('public/assets/css/neon-core.css')}}">
	<link rel="stylesheet" href="{{  asset('public/assets/css/neon-theme.css')}}">
	<link rel="stylesheet" href="{{  asset('public/assets/css/neon-forms.css')}}">
	<link rel="stylesheet" href="{{  asset('public/assets/css/custom.css')}}">
	<link rel="stylesheet" href="{{  asset('public/assets/css/skins/purple.css')}}">

	<script src="{{ asset('public/assets/js/jquery-1.11.0.min.js')}}"></script>

	<!--[if lt IE 9]><script src="{{ asset('public/assets/js/ie8-responsive-file-warning.js')}}"></script><![endif]-->
...
<body class="page-body skin-purple" data-url="http://neon.dev">
		...
		<header class="logo-env">
			...
			<div class="sui-normal">
				<a href="#" class="user-link">
					<img src="public/assets/images/thumb-1.png" alt="" class="img-circle" />
...
<li class="external">
	...
	<ul class="dropdown-menu-list scroller">
		...
		<li class="active">
			<a href="#">
				<span class="image pull-right">
					<img src="public/assets/images/thumb-2.png" alt="" class="img-circle" />
				</span>
		...
		<li>
			<a href="#">
				<span class="image pull-right">
					<img src="public/assets/images/thumb-3.png" alt="" class="img-circle" />
				</span>
		...
		<li>
			<a href="#">
				<span class="image pull-right">
					<img src="public/assets/images/thumb-4.png" alt="" class="img-circle" />
				</span>
		...
		<ul class="list-inline links-list pull-right">
			...
			<!-- Language Selector -->			<li class="dropdown language-selector">
				...
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" data-close-others="true">
					<img src="public/assets/images/flag-uk.png" />
				</a>
				
				<ul class="dropdown-menu pull-right">
					<li>
						<a href="#">
							<img src="public/assets/images/flag-de.png" />
							<span>Deutsch</span>
						</a>
					</li>
					<li class="active">
					...
					<li>
						<a href="#">
							<img src="public/assets/images/flag-fr.png" />
							<span>François</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="public/assets/images/flag-al.png" />
							<span>Shqip</span>
						</a>
					</li>
					<li>
						<a href="#">
							<img src="public/assets/images/flag-es.png" />
							<span>Español</span>
						</a>
					</li>
				</ul>
	...
	<div class="col-sm-9">
		...
		<div class="tile-group">
			...
			<div class="tile-left">
				...
				<div class="tile-entry">
					<img src="public/assets/images/sample-al.png" alt="" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="public/assets/images/sample-it.png" alt="" class="pull-right op" />
				...
				<div class="tile-entry">
					<img src="public/assets/images/sample-au.png" alt="" class="pull-right op" />
...
<div class="modal gray fade" id="sample-modal-dialog-3">
	...
	<link rel="stylesheet" href="{{  asset('public/assets/js/jvectormap/jquery-jvectormap-1.2.2.css')}}">
	<link rel="stylesheet" href="{{  asset('public/assets/js/rickshaw/rickshaw.min.css')}}">

	<!-- Bottom Scripts -->
	<script src="{{ asset('public/assets/js/gsap/main-gsap.js')}}"></script>
	<script src="{{ asset('public/assets/js/jquery-ui/js/jquery-ui-1.10.3.minimal.min.js')}}"></script>
	<script src="{{ asset('public/assets/js/bootstrap.js')}}"></script>
	<script src="{{ asset('public/assets/js/joinable.js')}}"></script>
	<script src="{{ asset('public/assets/js/resizeable.js')}}"></script>
	<script src="{{ asset('public/assets/js/neon-api.js')}}"></script>
	<script src="{{ asset('public/assets/js/jvectormap/jquery-jvectormap-1.2.2.min.js')}}"></script>
	<script src="{{ asset('public/assets/js/jvectormap/jquery-jvectormap-europe-merc-en.js')}}"></script>
	<script src="{{ asset('public/assets/js/jquery.sparkline.min.js')}}"></script>
	<script src="{{ asset('public/assets/js/rickshaw/vendor/d3.v3.js')}}"></script>
	<script src="{{ asset('public/assets/js/rickshaw/rickshaw.min.js')}}"></script>
	...
	<script src="{{ asset('public/assets/js/neon-chat.js')}}"></script>
	<script src="{{ asset('public/assets/js/neon-custom.js')}}"></script>
	<script src="{{ asset('public/assets/js/neon-demo.js')}}"></script>
